...
if __name__ == '__main__':
    ...
    for i in range(args.analysis_start, args.analysis_end):
        ...
        reset_w_mask, reset_b_mask = pruner.cal_mask_l1(1.0)
        masks.update_mask(layer, reset_w_mask, reset_b_mask)
    print(sense_re)
    filename = '%s_sensitivity_withfinetune_%d_%d.json' % (args.network, args.analysis_start, args.analysis_end)
